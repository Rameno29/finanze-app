    ...
    <div className="pb-28">
      ...
      <div className="mx-auto flex max-w-lg flex-col gap-3 px-5 pt-4">
        ...
        <Section icon={FileText} title="Documenti">
          ...
          <P><B>Scanner documenti</B> — fotografa carta d'identità, moduli o contratti, anche su più pagine: AJE <B>riconosce da solo i bordi del foglio, lo ritaglia e lo raddrizza</B> come una vera scansione (anche se la foto è storta o in prospettiva). Col bottone dei bordi puoi <B>trascinare i 4 angoli</B> a mano — tenendo premuto compare una <B>lente d'ingrandimento</B> per la massima precisione — oppure usare <B>"Trova i bordi con l'AI"</B>: Gemini individua gli angoli del documento anche quando il contrasto è scarso (questo bottone invia la foto alla funzione AI sicura del server; tutto il resto resta sul telefono). Per ogni pagina scegli il filtro (Migliorato, Grigio, B/N o Originale), ruoti o elimini, poi <B>Condividi PDF</B> apre il foglio di iOS per mandarlo su WhatsApp, Mail o dove vuoi. Puoi anche scaricarlo o salvarlo nei Documenti. Le foto restano sul telefono: niente viene inviato a nessun server finché non scegli tu.</P>
        </Section>
